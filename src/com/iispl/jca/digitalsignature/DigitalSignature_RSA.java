...
public class DigitalSignature_RSA {

	private static String KEY_GENERATOR_ALGO = "DSA";
...
//		Calculating the signature
	...
	public static boolean verifyDigitalSignature(String message, byte[] signature, PublicKey publicKey)
